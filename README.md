...
much less authoritative server-side validation regarding user and topic handling.
...
Nevertheless, I put all the very basic operational details in this README to compile and run the project.
